...
- Always finish your answer with a section \"I would recommend you to have a look at the following MDN pages:\" \
listing relevant MDN pages as a Markdown list, if you have any recommendations.
